                    ...
                    <ul className="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li className="nav-item nav-item-submenu">
                            ...
                            <ul className="nav nav-group-sub" data-submenu-title="Themes">
                                ...
                                <li className="nav-item">
                                    <a href="../../material/full/index.html" className="nav-link">
                                        Material
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a href="../../dark/full/index.html" className="nav-link">
                                        Dark
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a
                                        href="../../clean/full/index.html"
                                        className="nav-link disabled"
                                    >
                                        Clean{' '}
                                        <span className="badge bg-transparent align-self-center ml-auto">
                        ...
                        <li className="nav-item nav-item-submenu">
                            ...
                            <ul className="nav nav-group-sub" data-submenu-title="Starter kit">
                                <li className="nav-item">
                                    <a href="../seed/layout_navbar_fixed.html" className="nav-link">
                                        Fixed navbar
                                    </a>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <a href="../seed/layout_fixed_footer.html" className="nav-link">
                                        Fixed footer
                                    </a>
                                </li>
                                <li className="nav-item-divider" />
                        ...
                        <li className="nav-item">
                            <a href="../../../RTL/default/full/index.html" className="nav-link">
                        ...
                        <li className="nav-item nav-item-submenu">
                            <a href="!#" className="nav-link">
                                <i className="icon-indent-decrease2" /> <span>Sidebars</span>
                            </a>
                            <ul className="nav nav-group-sub" data-submenu-title="Sidebars">
                                ...
                                <li className="nav-item nav-item-submenu">
                                    ...
                                    <ul className="nav nav-group-sub">
                                        ...
                                        <li className="nav-item">
                                            <a
                                                href="sidebar_right_hidden.html"
                                                className="nav-link"
                                            >
                                                Hidden
                                            </a>
                        ...
                        <li className="nav-item nav-item-submenu">
                            <a href="!#" className="nav-link">
                                <i className="icon-sort" /> <span>Vertical navigation</span>
                            </a>
                            <ul
                            ...
                            >
                                ...
                                <li className="nav-item">
                                    <a href="navigation_vertical_badges.html" className="nav-link">
                                        Badges
                                    </a>
                                </li>
                                <li className="nav-item">
                        ...
                        <li className="nav-item nav-item-submenu">
                            ...
                            >
                                <li className="nav-item">
                                    <a href="navigation_horizontal_click.html" className="nav-link">
                                        Submenu on click
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a href="navigation_horizontal_hover.html" className="nav-link">
                                        Submenu on hover
                                    </a>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <a href="navigation_horizontal_tabs.html" className="nav-link">
                                        Tabbed navigation
                                    </a>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <a href="navigation_horizontal_mega.html" className="nav-link">
                        ...
                        <li className="nav-item nav-item-submenu">
                            ...
                            <ul className="nav nav-group-sub" data-submenu-title="Menu levels">
                                ...
                                <li className="nav-item nav-item-submenu">
                                    <a href="!#" className="nav-link">
                                        <i className="icon-firefox" /> Second level with child
                                    </a>
                                    <ul className="nav nav-group-sub">
                                        <li className="nav-item">
                                            <a href="!#" className="nav-link">
                                        ...
                                        <li className="nav-item nav-item-submenu">
                                            <a href="!#" className="nav-link">
                                                <i className="icon-apple2" /> Third level with child
                                            </a>
                                            <ul className="nav nav-group-sub">
                                                <li className="nav-item">
                                                    <a href="!#" className="nav-link">
